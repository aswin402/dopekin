...
export function BannerSkeleton() {
  return (
    <div className="w-[calc(100%+2rem)] -mx-4 sm:mx-0 sm:w-full aspect-[1.6/1] sm:aspect-[2.4/1] md:aspect-[2.75/1] lg:aspect-[2.85/1] rounded-none sm:rounded-3xl bg-zinc-950 border-y border-x-0 sm:border border-white/5 p-6 sm:p-10 flex flex-col justify-between animate-pulse">
