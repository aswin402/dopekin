...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-8 animate-fade-up px-4 md:px-6 py-6 pb-24 text-left max-w-7xl mx-auto">
      ...
      {/* TWO-COLUMN LAYOUT: CONTINUE CHATTING & RECENT ACTIONS */}
      <div className="grid lg:grid-cols-12 gap-8">
        
        {/* Left Column: Continue Chatting Slider */}
        ...
        {/* Right Column: Recent Activity & Daily Suggestions */}
        <div className="lg:col-span-4 flex flex-col gap-6">
          {/* Recent Activity */}
          <div className="flex flex-col gap-3.5 bg-zinc-950 border border-white/5 rounded-2xl p-4 text-left">
            <div className="flex justify-between items-center border-b border-white/5 pb-2">
              <h4 className="text-[10px] font-mono font-black uppercase text-zinc-400 tracking-wider">
                Recent Activity
              </h4>
              <span className="text-[9px] font-bold text-zinc-500 uppercase cursor-pointer hover:text-white">View all</span>
            </div>

            <div className="flex flex-col gap-3 font-body">
              {[
                { id: 'serena', text: 'sent you a message', time: '2m ago' },
                { id: 'vale', text: 'remembered your favorite movie', time: '1h ago' },
                { id: 'cody', text: 'invited you to a video call', time: '1h ago' },
                { id: 'rina', text: 'released a new episode', time: '4h ago' }
              ].map((act, idx) => {
                const twin = getTwin(act.id);
                return (
                  <div key={idx} className="flex items-center gap-3 text-xs leading-normal">
                    ...
                    <div className="flex flex-col min-w-0">
                      <p className="text-zinc-300 truncate">
                        <span className="font-bold text-white mr-1">{twin.name}</span>
                        {act.text}
                      </p>
                      <span className="text-[9px] text-zinc-500 font-mono mt-0.5">{act.time}</span>
                    </div>
                  </div>
                );
              })}
          ...
          {/* Daily Suggestions */}
          <div className="flex flex-col gap-3.5 bg-zinc-950 border border-white/5 rounded-2xl p-4 text-left">
            <h4 className="text-[10px] font-mono font-black uppercase text-zinc-400 tracking-wider border-b border-white/5 pb-2">
              Daily Suggestions
            </h4>
            ...
            <div className="flex flex-col gap-3 font-body text-xs">
              ...
              >
                ...
                <div className="flex flex-col text-left">
                  <span className="font-bold text-white">Try a new voice call</span>
                  <span className="text-[10px] text-zinc-500 font-medium">Connect deeper with voice dialogues</span>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex flex-col text-left">
                  <span className="font-bold text-white">Explore new companions</span>
                  <span className="text-[10px] text-zinc-500 font-medium">Find your next favorite clone</span>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex flex-col text-left">
                  <span className="font-bold text-white">Create your AI twin</span>
                  <span className="text-[10px] text-zinc-500 font-medium">Build your customized digital version</span>
                </div>
              </div>
            </div>
          </div>
